 ...
 * @author hp
 */
public class OrderIsNOTFound extends javax.swing.JFrame {

    /**
     * Creates new form StartUpPage
     */
    public OrderIsNOTFound() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText(" is not in the system");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrderIsNOTFound.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
