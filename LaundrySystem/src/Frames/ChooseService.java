...
public class ChooseService extends javax.swing.JFrame {
    ...
    public ChooseService(Customer cust) {
        initComponents();
        Cust = cust;
    }

    public ChooseService(Customer cust, Order order) {
        initComponents();
        Cust = cust;
        Order = order;
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(MainPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 853, Short.MAX_VALUE)
        );
