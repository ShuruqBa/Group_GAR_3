...
public class OrderDetails extends javax.swing.JFrame {
    ...
    public OrderDetails(Customer cust) {
        initComponents();
    ...
    public OrderDetails(Customer cust, Order order) {
        initComponents();
    ...
    private void initComponents() {
        ...
        MainPanel.setPreferredSize(new java.awt.Dimension(404, 600));
        MainPanel.setRequestFocusEnabled(false);

        Continue.setBackground(new java.awt.Color(102, 100, 139));
        Continue.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        Continue.setForeground(new java.awt.Color(255, 255, 255));
        Continue.setText("Continue");
        Continue.setPreferredSize(new java.awt.Dimension(250, 39));
