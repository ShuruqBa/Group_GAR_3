...
public class SignUpFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setPreferredSize(new java.awt.Dimension(404, 310));

        jLabel2.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(102, 102, 102));
        jLabel2.setText("Full Name");

        FullName.setBackground(new java.awt.Color(220, 220, 255));
        FullName.setFont(new java.awt.Font("Calibri", 0, 16)); // NOI18N
        FullName.setForeground(new java.awt.Color(112, 110, 153));
        FullName.setPreferredSize(new java.awt.Dimension(286, 28));
        FullName.setSelectionColor(new java.awt.Color(112, 110, 153));
    ...
    private void SignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpActionPerformed
        ...
        String[] fullName = FullName.getText().split(" ");
            ...
            if (!isValid(email)) {
                ...
                if (password.length < 8) {
                    ...
                    if (!passwordsMatch(password, confirmedPass)) {
                        ...
                        Customer customer = new Customer(PhoneNo.getText(), email, fullName[0], fullName[1], new String(password), null);
